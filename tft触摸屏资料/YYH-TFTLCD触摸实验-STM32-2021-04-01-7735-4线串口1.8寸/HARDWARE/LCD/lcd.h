...
//--1
#define	LCD_CS_SET  GPIOE->BSRR=1<<11    //片选端口  		PE11
#define	LCD_RES_SET	GPIOE->BSRR=1<<8    //数据/命令 		PE8	   
#define	LCD_A0_SET	GPIOE->BSRR=1<<10    //写数据			PE10
#define	LCD_SDA_SET	GPIOE->BSRR=1<<12    //读数据			PE12
#define	LCD_SCL_SET	GPIOE->BSRR=1<<9    //读数据			PE9

//--0
#define	LCD_CS_CLR  GPIOE->BRR=1<<11     //片选端口  		PE11
#define	LCD_RES_CLR	GPIOE->BRR=1<<8     //数据/命令		PE8	   
#define	LCD_A0_CLR	GPIOE->BRR=1<<10     //写数据			PE10
#define	LCD_SDA_CLR	GPIOE->BRR=1<<12     //读数据			PE12 
#define	LCD_SCL_CLR	GPIOE->BRR=1<<9     //读数据			PE9 
