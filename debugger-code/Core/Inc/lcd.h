...
//--1
#define    LCD_CS_SET  GPIOC->BSRR=1<<12    //片选端口  		PE11
#define    LCD_RES_SET   HAL_GPIO_WritePin(GPIOB, GPIO_PIN_6, GPIO_PIN_SET);//GPIOB->BSRR=1<<6    //数据/命令 		PE8
#define    LCD_A0_SET    GPIOB->BSRR=1<<4    //写数据			PE10
#define    LCD_SDA_SET    GPIOB->BSRR=1<<5    //读数据			PE12
#define    LCD_SCL_SET    GPIOB->BSRR=1<<3   //读数据			PE9

//--0
#define    LCD_CS_CLR  GPIOC->BRR=1<<12    //片选端口  		PE11
#define    LCD_RES_CLR    HAL_GPIO_WritePin(GPIOB, GPIO_PIN_6, GPIO_PIN_RESET);    //数据/命令		PE8
#define    LCD_A0_CLR    GPIOB->BRR=1<<4     //写数据			PE10
#define    LCD_SDA_CLR    GPIOB->BRR=1<<5     //读数据			PE12
#define    LCD_SCL_CLR    GPIOB->BRR=1<<3    //读数据			PE9
